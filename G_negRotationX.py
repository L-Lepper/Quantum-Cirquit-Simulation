...
class negRotationX(QGate):
    """
    Klasse für das -RX Gatter. -90°-Rotation um die X-Achse. Speichert den Typ und erweitert die Matrix dieses Gatters
    ...
    def __init__(self, list_affected_qubits):
        ...
        self.general_matrix = 1/math.sqrt(2) * np.array([[1, 1j], [1j, 1]], dtype=complex)
